...
serve(async (req) => {
  ...
  try {
    ...
    // Prepare form data for Lovable AI (using Gemini for transcription)
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Please transcribe the following audio exactly as spoken. Only return the transcription, nothing else."
              },
              {
                type: "input_audio",
                input_audio: {
